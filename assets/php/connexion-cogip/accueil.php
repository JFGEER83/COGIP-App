<?php
$bdd = new PDO('mysql:host=127.0.0.1;dbname=apps_cogip', 'root', '');
...
<a href="../facture-cogip/facture.php">voir toutes les factures</a>
...
<!-- les personnes -->
<H2>Mes 5 dernières personnes</H2>
           <?php while($m = $membres3 -> fetch()){ ?>
<li><?= $m['idPERSONNES'] ?>

: <?=$m['prenom_presonne'] ?> <?=$m['nom_personne'] ?>
...
- <a href="index8.php?supprime=<?= $m['idPERSONNES']?>">supprimer</a></li>
  ...
  <?php } ?>
   ...
   <a href="../contact/contactpage.php">voir toutes les personnes</a>
